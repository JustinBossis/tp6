function main(){
    ...
    let nbColonne = (document.getElementsByTagName("td").length+document.getElementsByTagName("th").length)/nbLigne;
    let nbSemestre = document.getElementsByClassName("newSemestre").length;
